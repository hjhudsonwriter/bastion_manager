...
function renderDiplomacy(){
  ...
  hallCard.innerHTML = `
    <div class="hallTop">
      <div>
        <div class="hallNameRow">
          <div class="hallName">Hall of Emissaries</div>
          <div class="hallLevel">L${hallLvl}</div>
          ${upgradeBtn}
        </div>
        <div class="small muted">Diplomatic actions take 1 Bastion Turn.</div>
      </div>
    </div>
  ...
  // Wire upgrade pill
  const up = hallCard.querySelector("[data-action='hallUpgrade']");
  if(up){
